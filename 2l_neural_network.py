...
def backward(x,y,a1,a2,W2):
    ...
    dz2_dW2 = compute_dz2_dW2(a1,len(dL_da2))
    dz2_db2 = compute_dz2_db2(len(dL_da2))
    # 1st layer
...
def compute_gradients(dL_da2, da2_dz2, dz2_dW2, dz2_db2, dz2_da1, da1_dz1, dz1_dW1, dz1_db1):
    ...
    # the 1st layer
    dL_dW1 = np.multiply(np.multiply(dz1_dW1, da1_dz1), dz2_da1.T * sr.compute_dL_dz(dL_da2, da2_dz2))
    dL_db1 = np.multiply(np.multiply(dz1_db1, da1_dz1), dz2_da1.T * sr.compute_dL_dz(dL_da2, da2_dz2))
    #########################################
...
def predict(Xtest, W1,b1,W2,b2):
    ...
    for i, x in enumerate(Xtest):
        ...
        P[i,] = a2.T
        # decide label by finding the index of the max value in a
        Y[i] = np.argmax(a2.T)
